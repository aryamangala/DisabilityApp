...
const styles = StyleSheet.create({
  ...
  iconBackground: {
    ...
    backgroundColor: "#B42318", justifyContent: "center", alignItems: "center",
    marginBottom: 16,
    shadowColor: "#000", shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.1, shadowRadius: 4, elevation: 3,
  },
  iconText: { fontSize: 40, color: "#fff" },
  title: { fontSize: 32, fontWeight: "700", color: "#2C2C2C", marginBottom: 4 },
  ...
  form: { gap: 4 },
  label: { fontSize: 14, fontWeight: "600", color: "#2C2C2C", marginBottom: 4, marginTop: 12 },
  input: {
    borderWidth: 1, borderColor: "#D1C9B0", borderRadius: 10,
    padding: 14, fontSize: 16, backgroundColor: "#FAF7F2", color: "#2C2C2C",
  },
  forgotLink: { alignSelf: "flex-end", marginTop: 8, marginBottom: 4 },
  linkText: { color: "#B42318", fontWeight: "600" },
  primaryButton: {
    backgroundColor: "#B42318", borderRadius: 12,
  ...
  secondaryButtonText: { fontSize: 14, color: "#4A4A4A" },
});
